...
lazy_static! {
    pub static ref RULES: [Rule; 4] = [
        Rule{title: None,       class: None,        process_filename: Some("KakaoTalk".to_string()),         is_floating: true,      tags: 111111111},
        Rule{title: Some("화면 속 화면".to_string()),       class: None,        process_filename: None,         is_floating: true,      tags: 111111111},
